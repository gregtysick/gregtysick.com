...
- `site/` - public deployable website files
- `docs/` - deployment notes and migration context
- `README.md` - repository overview
- `AGENTS.md` - repo-specific agent instructions

## Next Steps

- Verify the current WHC account state.
- Confirm the backup path for the WordPress migration.
- Create or update the public GitHub repository and connect this checkout to it.
